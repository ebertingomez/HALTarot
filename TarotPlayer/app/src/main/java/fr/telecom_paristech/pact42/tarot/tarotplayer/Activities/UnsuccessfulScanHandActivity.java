 ...
 */
public class UnsuccessfulScanHandActivity extends AppCompatActivity implements View.OnClickListener {
    /**
    ...
    public void onClick(View v) {
        ...
        case R.id.unsucess_scanGo:
            ScanHandActivity.cardsScanned++;
            currentGame.addPlayingCard(spinner.getSelectedItem().toString());
            break;

        }
        Intent scanHandActivity = new Intent(UnsuccessfulScanHandActivity.this,
