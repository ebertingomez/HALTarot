 ...
 */
public class UnsuccessfulScanChienActivity extends AppCompatActivity implements View.OnClickListener {
    /**
    ...
    public void onClick(View v) {
        ...
        case R.id.unsucess_scanGo:
            ScanChienActivity.cardsScanned++;
            currentGame.addChienCard(spinner.getSelectedItem().toString());

            break;

        }
        Intent scanChienActivity = new Intent(UnsuccessfulScanChienActivity.this,
                fr.telecom_paristech.pact42.tarot.tarotplayer.Activities.ScanChienActivity.class);
        scanChienActivity.putExtra("fr.telecom_paristech.pact42.tarot.tarotplayer.CardGame.TAROTGAME", currentGame);
        startActivity(scanChienActivity);
    }
}
